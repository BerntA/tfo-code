...
#define HIDEHUD_BONUS_PROGRESS		( 1<<10 )	// Hide bonus progress display (for bonus map challenges)
#define HIDEHUD_DIALOGUE            ( 1<<11 )
#define HIDEHUD_INSELECTION         ( 1<<12 )   // Hide HUD when in weapon selection.
