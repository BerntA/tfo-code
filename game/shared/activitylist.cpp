...
void ActivityList_RegisterSharedActivities( void )
{
	...
	// TFO Activities
	REGISTER_SHARED_ACTIVITY ( ACT_VM_IDLE_TO_AIM );
	REGISTER_SHARED_ACTIVITY ( ACT_VM_AIM_TO_IDLE );
	REGISTER_SHARED_ACTIVITY ( ACT_VM_AIM_IDLE );
	REGISTER_SHARED_ACTIVITY ( ACT_VM_AIM_SHOOT );
	REGISTER_SHARED_ACTIVITY ( ACT_VM_IDLE_TO_RUN );
	REGISTER_SHARED_ACTIVITY ( ACT_VM_RUN_TO_IDLE );
	REGISTER_SHARED_ACTIVITY ( ACT_VM_RUN_IDLE );
	REGISTER_SHARED_ACTIVITY ( ACT_VM_JUMP );
	REGISTER_SHARED_ACTIVITY ( ACT_VM_SWIM );
	REGISTER_SHARED_ACTIVITY ( ACT_VM_IDLE_TO_TAKE );
	REGISTER_SHARED_ACTIVITY ( ACT_VM_TAKE_TO_IDLE );
	REGISTER_SHARED_ACTIVITY ( ACT_VM_TAKE_IDLE );
	REGISTER_SHARED_ACTIVITY(ACT_VM_BASH);
