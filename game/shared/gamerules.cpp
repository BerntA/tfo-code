...
void CGameRules::ShowNote( const char *szFile )
{
#ifndef CLIENT_DLL
	IGameEvent *event = gameeventmanager->CreateEvent( "display_note" );
	if( event )
	{
...
void CGameRules::AddToInventory( const char *szFile )
{
#ifndef CLIENT_DLL
	IGameEvent *event = gameeventmanager->CreateEvent( "inventory_add" );
	if( event )
	{
		event->SetString( "script", szFile );
		gameeventmanager->FireEvent( event );
...
void CGameRules::RemoveItemFromInventory(const char *szFile )
{
#ifndef CLIENT_DLL
	IGameEvent *event = gameeventmanager->CreateEvent( "inventory_remove" );
	if( event )
	{
		event->SetString("script", szFile);
		gameeventmanager->FireEvent( event );
...
void CGameRules::MapTransitionStarting( void )
{
#ifndef CLIENT_DLL
	IGameEvent *event = gameeventmanager->CreateEvent( "tfo_map_transition" );
	if( event )
	{
		gameeventmanager->FireEvent( event );
	}
...
void CGameRules::MapTransitionFinished( void )
{
#ifndef CLIENT_DLL
	IGameEvent *event = gameeventmanager->CreateEvent( "tfo_map_transition_finished" );
	if( event )
	{
		gameeventmanager->FireEvent( event );
	}
...
void CGameRules::MainMenuLoaded( void )
{
#ifndef CLIENT_DLL
	IGameEvent *event = gameeventmanager->CreateEvent( "tfo_mainmenu_loaded" );
	if( event )
	{
		gameeventmanager->FireEvent( event );
	}
