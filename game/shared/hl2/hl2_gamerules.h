...
public:
	...
	// Dynamic Precache of all inventory items:
	// WE have to precache all items even if you're never going to find some of those items in the map, if you add items to your inventory through the console then the 3D models will not show up unless they've been precached.
	void GetModelsAndDoPrecache();
