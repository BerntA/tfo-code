...
ConVar	sk_plr_dmg_stg44		( "sk_plr_dmg_stg44","0", FCVAR_REPLICATED );
ConVar	sk_npc_dmg_stg44		( "sk_npc_dmg_stg44","0", FCVAR_REPLICATED);
ConVar	sk_max_stg44			( "sk_max_stg44","0", FCVAR_REPLICATED);
...
ConVar	sk_plr_dmg_thompson("sk_plr_dmg_thompson", "0", FCVAR_REPLICATED);
ConVar	sk_npc_dmg_thompson("sk_npc_dmg_thompson", "0", FCVAR_REPLICATED);
ConVar	sk_max_thompson("sk_max_thompson", "0", FCVAR_REPLICATED);

ConVar	sk_plr_dmg_p38("sk_plr_dmg_p38", "0", FCVAR_REPLICATED);
ConVar	sk_npc_dmg_p38("sk_npc_dmg_p38", "0", FCVAR_REPLICATED);
ConVar	sk_max_p38("sk_max_p38", "0", FCVAR_REPLICATED);

ConVar	sk_plr_dmg_fg42		( "sk_plr_dmg_fg42","0", FCVAR_REPLICATED );
ConVar	sk_npc_dmg_fg42		( "sk_npc_dmg_fg42","0", FCVAR_REPLICATED);
ConVar	sk_max_fg42			( "sk_max_fg42","0", FCVAR_REPLICATED);

ConVar	sk_plr_dmg_g43			( "sk_plr_dmg_g43","0", FCVAR_REPLICATED );
ConVar	sk_npc_dmg_g43		( "sk_npc_dmg_g43","0", FCVAR_REPLICATED);
ConVar	sk_max_g43				( "sk_max_g43","0", FCVAR_REPLICATED);

ConVar	sk_plr_dmg_svt40			( "sk_plr_dmg_svt40","0", FCVAR_REPLICATED );
ConVar	sk_npc_dmg_svt40		( "sk_npc_dmg_svt40","0", FCVAR_REPLICATED);
ConVar	sk_max_svt40				( "sk_max_svt40","0", FCVAR_REPLICATED);

ConVar	sk_plr_dmg_k98			( "sk_plr_dmg_k98","0", FCVAR_REPLICATED );
ConVar	sk_npc_dmg_k98		( "sk_npc_dmg_k98","0", FCVAR_REPLICATED);
ConVar	sk_max_k98				( "sk_max_k98","0", FCVAR_REPLICATED);
...
ConVar  alyx_darkness_force( "alyx_darkness_force", "0", FCVAR_CHEAT | FCVAR_REPLICATED );
	...
	void CHalfLife2::InitDefaultAIRelationships( void )
	{
		...
		*/
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_REBEL,       CLASS_SOLDIER_ANGRY,    D_NU, 0);
		...
		//	> CLASS_SOLDIER_ANGRY
		// ------------------------------------------------------------
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SOLDIER_ANGRY, CLASS_NONE, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SOLDIER_ANGRY, CLASS_PLAYER, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SOLDIER_ANGRY, CLASS_ANTLION, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SOLDIER_ANGRY, CLASS_BARNACLE, D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SOLDIER_ANGRY, CLASS_BULLSEYE, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SOLDIER_ANGRY, CLASS_SOLDIER_ANGRY, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SOLDIER_ANGRY, CLASS_CITIZEN_PASSIVE, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SOLDIER_ANGRY, CLASS_CITIZEN_REBEL, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SOLDIER_ANGRY, CLASS_COMBINE, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SOLDIER_ANGRY, CLASS_COMBINE_GUNSHIP, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SOLDIER_ANGRY, CLASS_COMBINE_HUNTER, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SOLDIER_ANGRY, CLASS_CONSCRIPT, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SOLDIER_ANGRY, CLASS_FLARE, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SOLDIER_ANGRY, CLASS_HEADCRAB, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SOLDIER_ANGRY, CLASS_MANHACK, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SOLDIER_ANGRY, CLASS_METROPOLICE, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SOLDIER_ANGRY, CLASS_MILITARY, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SOLDIER_ANGRY, CLASS_MISSILE, D_FR, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SOLDIER_ANGRY, CLASS_SCANNER, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SOLDIER_ANGRY, CLASS_STALKER, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SOLDIER_ANGRY, CLASS_VORTIGAUNT, D_LI, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SOLDIER_ANGRY, CLASS_ZOMBIE, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SOLDIER_ANGRY, CLASS_PROTOSNIPER, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SOLDIER_ANGRY, CLASS_EARTH_FAUNA, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SOLDIER_ANGRY, CLASS_PLAYER_ALLY, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SOLDIER_ANGRY, CLASS_PLAYER_ALLY_VITAL, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SOLDIER_ANGRY, CLASS_HACKED_ROLLERMINE, D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE,         CLASS_SOLDIER_ANGRY,    D_HT, 0);
		...
		*/
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_ZOMBIE,          CLASS_SOLDIER_ANGRY,    D_HT, 0);
...
//-----------------------------------------------------------------------------
// Purpose: Handle Loaded Save Name so we can parse it's related script!
//-----------------------------------------------------------------------------
void CHalfLife2::SetCurrentLoadedSave( const char *szSave )
{
	tfo_selected_save.SetValue( szSave );
}
...
//-----------------------------------------------------------------------------
// Purpose: Iterates all sub keys, ALL of them. If we ever find a "modelname" key then precache its value.
//-----------------------------------------------------------------------------
void CHalfLife2::IterateKeyValuesAndPrecache(KeyValues *pkvKey)
{
#ifndef CLIENT_DLL

	for (KeyValues *sub = pkvKey->GetFirstSubKey(); sub; sub = sub->GetNextKey())
	{
		const char *szModel = sub->GetString("modelname");
		if (szModel && strlen(szModel) > 0)
			CBaseEntity::PrecacheModel(szModel);

		IterateKeyValuesAndPrecache(sub);
	}
...
//-----------------------------------------------------------------------------
// Purpose: Searches all files in the items folder for inventory stuff, reads their keyvalue data and calls IterateKeyValuesAndPrecache(inData); 
//-----------------------------------------------------------------------------
void CHalfLife2::GetModelsAndDoPrecache()
{
#ifndef CLIENT_DLL

	char szFullFilePath[MAX_WEAPON_STRING];
	Q_strncpy(szFullFilePath, "", MAX_WEAPON_STRING);
	...
	while (pFilename)
	{
		...
		if (gameData->LoadFromFile(filesystem, szFullFilePath, "MOD"))
			IterateKeyValuesAndPrecache(gameData);
...
CAmmoDef *GetAmmoDef()
{
	...
	if ( !bInitted )
	{
		...
		def.AddAmmoType("AR2",              DMG_BULLET,                 TRACER_LINE_AND_WHIZ,   40,                         40,                         40,                     BULLET_IMPULSE(200, 1225), 0);
		def.AddAmmoType("AlyxGun",			DMG_BULLET,					TRACER_LINE,			"sk_plr_dmg_alyxgun",		"sk_npc_dmg_alyxgun",		"sk_max_alyxgun",		BULLET_IMPULSE(200, 1225), 0 );
		def.AddAmmoType("P38",			    DMG_BULLET,					TRACER_LINE_AND_WHIZ,	"sk_plr_dmg_p38",		    "sk_npc_dmg_p38",		    "sk_max_p38",		    BULLET_IMPULSE(200, 1225), 0 );
		def.AddAmmoType("MP40",				DMG_BULLET,					TRACER_LINE_AND_WHIZ,	"sk_plr_dmg_mp40",			"sk_npc_dmg_mp40",			"sk_max_mp40",			BULLET_IMPULSE(250, 1300), 0 );
		def.AddAmmoType("THOMPSON",         DMG_BULLET,                 TRACER_LINE_AND_WHIZ,   "sk_plr_dmg_thompson",      "sk_npc_dmg_thompson",      "sk_max_thompson",      BULLET_IMPULSE(400, 1600), 0);
		def.AddAmmoType("STG44",			DMG_BULLET,					TRACER_LINE_AND_WHIZ,	"sk_plr_dmg_stg44",			"sk_npc_dmg_stg44",			"sk_max_stg44",			BULLET_IMPULSE(300, 1700), 0 );
		def.AddAmmoType("FG42",			    DMG_BULLET,					TRACER_LINE_AND_WHIZ,	"sk_plr_dmg_fg42",			"sk_npc_dmg_fg42",			"sk_max_fg42",			BULLET_IMPULSE(400, 3250), 0 );
		def.AddAmmoType("G43",				DMG_BULLET,					TRACER_LINE_AND_WHIZ,	"sk_plr_dmg_g43",			"sk_npc_dmg_g43",			"sk_max_g43",			BULLET_IMPULSE(300, 3000), 0 );
		def.AddAmmoType("SVT40",			DMG_BULLET,					TRACER_LINE_AND_WHIZ,	"sk_plr_dmg_svt40",			"sk_npc_dmg_svt40",			"sk_max_svt40",			BULLET_IMPULSE(450, 6000), 0 );
		def.AddAmmoType("K98",				DMG_BULLET,					TRACER_LINE_AND_WHIZ,	"sk_plr_dmg_k98",			"sk_npc_dmg_k98",			"sk_max_k98",			BULLET_IMPULSE(400, 5000), 0 );
		def.AddAmmoType("K98NS",			DMG_BULLET,					TRACER_LINE_AND_WHIZ,	"sk_plr_dmg_k98",			"sk_npc_dmg_k98",			"sk_max_k98",			BULLET_IMPULSE(400, 5000), 0 );
		def.AddAmmoType("Mauser",			DMG_BULLET,					TRACER_LINE_AND_WHIZ,	"sk_plr_dmg_mauser",			"sk_npc_dmg_mauser",	"sk_max_mauser",		BULLET_IMPULSE(200, 1200), 0 );
