...
// Functions to verify the single/multiplayer status of a game
	...
	void RemoveItemFromInventory( const char *szFile );
	void MapTransitionStarting( void );
	void MapTransitionFinished( void );
	void StartDialogueScene( const char *szFile, const char *szEntity, bool bOption1, bool bOption2, bool bOption3 );
	void MainMenuLoaded( void );
...
// Functions to verify the single/multiplayer status of a game
	...
	virtual const char *GetGameDescription( void ) { return "The Forgotten Ones"; }  // this is the game name that gets seen in the server browser
