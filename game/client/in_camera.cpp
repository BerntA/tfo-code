...
ConVar cam_idealdist( "cam_idealdist", "155", FCVAR_ARCHIVE );	 // thirdperson distance
ConVar cam_idealdistright( "cam_idealdistright", "0", FCVAR_ARCHIVE );	 // thirdperson distance
ConVar cam_idealdistup( "cam_idealdistup", "0", FCVAR_ARCHIVE );	 // thirdperson distance
...
#ifdef TF_CLIENT_DLL
static ConCommand thirdperson( "thirdperson", ::CAM_ToThirdPerson, "Switch to thirdperson camera.", FCVAR_ARCHIVE | FCVAR_SERVER_CAN_EXECUTE );
