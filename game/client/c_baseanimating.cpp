...
void MaterialFootstepSound( C_BaseAnimating *pEnt, bool bLeftFoot, float flVolume )
{
	...
	if(pPlayer != NULL && C_BasePlayer::GetLocalPlayer() == pPlayer && !(::input->CAM_IsThirdPerson()))
		return; // TFO Warn
	...
	case CL_EVENT_FOOTSTEP_LEFT:
		{
            ...
            if(IsPlayer())
            {
                ...
                if(C_BasePlayer::GetLocalPlayer() == pPlayer && !(::input->CAM_IsThirdPerson()))
                    break; // TFO Warn
            }
