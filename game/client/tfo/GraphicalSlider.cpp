...
//
// Purpose: Custom Slider with new overlays (button knob and slider meter)
//
//=============================================================================//
...
// Override Nob! The love of inheritance...
...
void GraphicalSlider::ApplySchemeSettings(vgui::IScheme *pScheme)
{
	...
	m_TickColor = Color(122, 73, 57, 255);
	m_TrackColor = Color(0, 0, 0, 0);

#ifdef _X360
	m_DepressedBgColor = Color( 122, 73, 57, 255 );
#endif

	m_DisabledTextColor1 = Color(100, 5, 5, 255);
	m_DisabledTextColor2 = Color(100, 5, 5, 255);
	...
	if (_rightCaption)
	{
		_rightCaption->SetColor(Color(100, 5, 5, 255));
		_rightCaption->SetFont(pScheme->GetFont("TFOInventorySmall", IsProportional()));
		_rightCaption->ResizeImageToContent();
	}

	if (_leftCaption)
	{
		_leftCaption->SetColor(Color(100, 5, 5, 255));
		_leftCaption->SetFont(pScheme->GetFont("TFOInventorySmall", IsProportional()));
