...
void CAI_BaseNPC::InitDefaultActivitySR(void) 
{
	...
	// TFO NEW ACTS
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_TO_AIM );
	ADD_ACTIVITY_TO_SR( ACT_VM_AIM_TO_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_VM_AIM_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_VM_AIM_SHOOT );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_TO_RUN );
	ADD_ACTIVITY_TO_SR( ACT_VM_RUN_TO_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_VM_RUN_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_VM_JUMP );
	ADD_ACTIVITY_TO_SR( ACT_VM_SWIM );
	ADD_ACTIVITY_TO_SR( ACT_VM_IDLE_TO_TAKE );
	ADD_ACTIVITY_TO_SR( ACT_VM_TAKE_TO_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_VM_TAKE_IDLE );
	ADD_ACTIVITY_TO_SR(ACT_VM_BASH);
