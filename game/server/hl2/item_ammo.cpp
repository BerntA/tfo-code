...
{
	"models/items/ws_supply.mdl",	// Small rounds
	"models/items/ws_supply.mdl",		// Medium rounds
	"models/items/ws_supply.mdl",		// Large rounds
	"models/items/ws_supply.mdl",	// RPG rounds
	"models/items/ws_supply.mdl",	// Buckshot
	"models/items/ws_supply.mdl",	// Grenades
	"models/items/ws_supply.mdl",		// 357
	"models/items/ws_supply.mdl",	// Crossbow
