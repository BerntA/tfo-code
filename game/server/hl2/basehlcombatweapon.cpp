...
void CHLMachineGun::DoMachineGunKick( CBasePlayer *pPlayer, float dampEasy, float maxVerticleKickAngle, float fireDurationTime, float slideLimitTime )
{
	...
	//pPlayer->ViewPunchReset( 10 ); Enabling this will make the lean bob / tilt reset as well so if you walk left or right you'll clip to normal angles and move back = nasty. @TFO
