...
BEGIN_DATADESC( CWeaponSchienzel )
END_DATADESC()
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponSchienzel::Precache( void )
{
	BaseClass::Precache();
}
...
//-----------------------------------------------------------------------------
void CWeaponSchienzel::Equip( CBaseCombatCharacter *pOwner )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponSchienzel::FireNPCPrimaryAttack( CBaseCombatCharacter *pOperator, Vector &vecShootOrigin, Vector &vecShootDir )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponSchienzel::Operator_ForceNPCFire( CBaseCombatCharacter *pOperator, bool bSecondary )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponSchienzel::Operator_HandleAnimEvent( animevent_t *pEvent, CBaseCombatCharacter *pOperator )
{
	switch( pEvent->event )
	{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CWeaponSchienzel::AddViewKick( void )
{
...
void CWeaponSchienzel::ItemPostFrame( void )
{
...
//-----------------------------------------------------------------------------
const WeaponProficiencyInfo_t *CWeaponSchienzel::GetProficiencyValues()
{
